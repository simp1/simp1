...
if (file_exists($target_file)) {
	header("Location: http://www01.bw.hs-offenburg.de/winprj01/werkzeugverwaltung.html?&werkzeugID=".$werkzeugID."&exist");
...
if ($_FILES["fileToUpload"]["size"] > 50000000) {
    ...
    header("Location: http://www01.bw.hs-offenburg.de/winprj01/werkzeugverwaltung.html?&werkzeugID=".$werkzeugID."&large");
    exit();
    $uploadOk = 0;
}
...
if($fileType != "pdf") {
			...
			header("Location: http://www01.bw.hs-offenburg.de/winprj01/werkzeugverwaltung.html?&werkzeugID=".$werkzeugID."&format");
			exit();
			$uploadOk = 0;
		}
