	...
	if(checktoken($token,$token_login,$username)){
		...
		if($erg>=0){
			...
			while($ausgabe = $statemt->fetch_object()){
				...
				$schlieﬂkraft = $ausgabe->schlieﬂkraft;
				
				$output .= "<tr><td>".$werkzeugID."</td><td>".$einsatzID."</td><td>".$laufendenummer."</td><td>".$datum."</td><td>".$schussnummer."</td><td>".$maschine."</td><td>".$kuehlung."</td><td>".$kuehldauer."</td><td>".$schlieﬂkraft."</td><td>";
