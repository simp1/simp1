		...
		if($erg>=0){
			...
			while($ausgabe = $statemt->fetch_object()){
				...
				if($erg>=1){
					...
					$output .="<td><button type='button' class='butosuccess' id=".$werkzeugID." onClick='openqr(id)'>QR-Code</button></td>";
					...
					$output .="<td><button type='button' class='butosuccess' id=".$werkzeugID." onClick='norights()'>QR-Code</button></td>";
					$output .="<td><button type='button' class='butosuccess' id=".$werkzeugnummer." onClick='openlink(id)'>oeffnen</button></td></tr>";
				}
				$output .="</div></table>";
